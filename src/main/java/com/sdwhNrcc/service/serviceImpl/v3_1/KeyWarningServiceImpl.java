...
public class KeyWarningServiceImpl implements KeyWarningService {
	...
	@Override
	public int add(KeyWarning keyWarning) {
		...
		int count=keyWarningDao.add(keyWarning);
		return count;
	}

	@Override
	public List<KeyWarning> queryEAList(int sync) {
		// TODO Auto-generated method stub
		return keyWarningDao.queryEAList(sync);
	}
	...
	public int syncByIds(String syncIds) {
		...
		return keyWarningDao.syncByIds(idList);
	}

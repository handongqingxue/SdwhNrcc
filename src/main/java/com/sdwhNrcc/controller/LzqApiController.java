...
public class LzqApiController {
	...
	public Map<String, Object> dataVideoAlarm(HttpServletRequest request) {
		...
		paramMap.put("alarmId", StringUtil.createUUID());
		...
		paramMap.put("alarmImage", alarmImage);
		
		doPostFormData("http://218.201.121.116:18009/data/video/alarm",paramMap);
		return resultMap;
	}
	 ...
	 * @return 响应结果
	 */
	public com.alibaba.fastjson.JSONObject doPostFormData(String url, Map<String, Object> paramMap) {
	    ...
	    httpPost.setHeader("authorization", "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MDIwOTQ3MzUsImV4cCI6MTcwMjA5NjUzNSwiVXNlcklkIjoiZjQ3YjA4NTktYmJlNi0xMWVjLTg3ODYtZjRlZTA4MTEwMzcxIiwiVXNlck5hbWUiOiLmt4TljZrpkavkub7ljJblt6XmnInpmZDlhazlj7giLCJBY2NvdW50Ijoi5reE5Y2a6ZGr5Lm-5YyW5bel5pyJ6ZmQ5YWs5Y-4In0.wXX130M-jPJ80uAo1P_sqzdlvu1Crw23qQnShYNQdR0");
	    try {
	        MultipartEntityBuilder builder = MultipartEntityBuilder.create();
	        //builder.setCharset(StandardCharsets.UTF_8);//这行语句会导致调用接口返回201码，可能是区平台那边乱码的问题，暂时注释掉
	        ...
	        for (Map.Entry<String, Object> entry : paramMap.entrySet()) {
		        ...
		        if("alarmImage".equals(key)) {
		        	MultipartFile multipartFile=(MultipartFile)entry.getValue();
			        String fileName = multipartFile.getOriginalFilename();
			        builder.addBinaryBody(key, multipartFile.getInputStream(), ContentType.MULTIPART_FORM_DATA, fileName);
		        }
		        else {
